...
/***/ function(module, exports, __webpack_require__) {
	...
	var proxyStore = new _reactChromeRedux.Store({ portName: "example-port" });

	(0, _reactDom.render)(_react2.default.createElement(
	    _reactRedux.Provider,
	    { store: proxyStore },
	    _react2.default.createElement(_App2.default, null)
	), document.getElementById('jobCE-anchor'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wrapStore = __webpack_require__(209);

	var _wrapStore2 = _interopRequireDefault(_wrapStore);

	var _alias = __webpack_require__(210);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	    ...
	    function App(props) {
	        ...
	        _this.addToClicks = _this.addToClicks.bind(_this);
	        return _this;
	    }

	    _createClass(App, [{
	        key: "addToClicks",
	        value: function addToClicks() {
	            this.props.dispatch({
	                type: "ADD_TO_CLICKER"
	            });
	        }
	...
	App.propTypes = {
	    ...
	    initialActions: _react.PropTypes.object
	};
